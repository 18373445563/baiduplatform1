...
import com.example.baiduplatform.entity.Hero;
...
public class SpinnerActivity extends AppCompatActivity {
    ...
    private void bindViews() {
        ...
        mData.add(new Hero(R.mipmap.loading_01,"迅捷斥候：提莫（Teemo）"));
        mData.add(new Hero(R.mipmap.loading_02,"诺克萨斯之手：德莱厄斯（Darius）"));
        mData.add(new Hero(R.mipmap.loading_03,"无极剑圣：易（Yi）"));
        mData.add(new Hero(R.mipmap.loading_04,"德莱厄斯：德莱文（Draven）"));
        mData.add(new Hero(R.mipmap.loading_05,"德邦总管：赵信（XinZhao）"));
        mData.add(new Hero(R.mipmap.loading_06,"狂战士：奥拉夫（Olaf）"));
